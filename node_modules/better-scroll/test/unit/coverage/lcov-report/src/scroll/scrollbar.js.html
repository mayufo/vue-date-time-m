  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>21/227</span>
      </div>
      <div class='fl pad1y space-right2'>
...
405
406
407</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { style, addEvent, removeEvent } from '../util/dom'
...
export function scrollbarMixin(BScroll) {
  BScroll.prototype._initScrollbar = function () <span class="fstat-no" title="function not covered" >{</span>
    const {fade = true, interactive = false} = <span class="cstat-no" title="statement not covered" >this.options.scrollbar</span>
...
<span class="cstat-no" title="statement not covered" >      this._removeScrollBars()</span>
    })
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    for (let i = 0; i &lt; this.indicators.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >      this.indicators[i].destroy()</span>
    }
  }
}
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.sizeRatioX = 1</span>
<span class="cstat-no" title="statement not covered" >  this.sizeRatioY = 1</span>
<span class="cstat-no" title="statement not covered" >  this.maxPosX = 0</span>
<span class="cstat-no" title="statement not covered" >  this.maxPosY = 0</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (options.interactive) {</span>
<span class="cstat-no" title="statement not covered" >    this._addDOMEvents()</span>
  }
}
&nbsp;
Indicator.prototype.handleEvent = function (e) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  switch (e.type) {</span>
    case 'touchstart':
    case 'mousedown':
<span class="cstat-no" title="statement not covered" >      this._start(e)</span>
<span class="cstat-no" title="statement not covered" >      break</span>
    case 'touchmove':
    case 'mousemove':
<span class="cstat-no" title="statement not covered" >      this._move(e)</span>
<span class="cstat-no" title="statement not covered" >      break</span>
    case 'touchend':
    case 'mouseup':
    case 'touchcancel':
    case 'mousecancel':
<span class="cstat-no" title="statement not covered" >      this._end(e)</span>
<span class="cstat-no" title="statement not covered" >      break</span>
  }
}
&nbsp;
Indicator.prototype.refresh = function () <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  if (this._shouldShow()) {</span>
...
&nbsp;
Indicator.prototype.destroy = function () <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  this._removeDOMEvents()</span>
<span class="cstat-no" title="statement not covered" >  this.wrapper.parentNode.removeChild(this.wrapper)</span>
}
&nbsp;
Indicator.prototype._start = function (e) <span class="fstat-no" title="function not covered" >{</span>
  let point = <span class="cstat-no" title="statement not covered" >e.touches ? e.touches[0] : e</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  this.transitionTime()</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.initiated = true</span>
<span class="cstat-no" title="statement not covered" >  this.moved = false</span>
<span class="cstat-no" title="statement not covered" >  this.lastPointX = point.pageX</span>
<span class="cstat-no" title="statement not covered" >  this.lastPointY = point.pageY</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.startTime = getNow()</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._handleMoveEvents(addEvent)</span>
<span class="cstat-no" title="statement not covered" >  this.scroller.trigger('beforeScrollStart')</span>
}
&nbsp;
Indicator.prototype._move = function (e) <span class="fstat-no" title="function not covered" >{</span>
  let point = <span class="cstat-no" title="statement not covered" >e.touches ? e.touches[0] : e</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  e.preventDefault()</span>
<span class="cstat-no" title="statement not covered" >  e.stopPropagation()</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!this.moved) {</span>
<span class="cstat-no" title="statement not covered" >    this.scroller.trigger('scrollStart')</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.moved = true</span>
&nbsp;
  let deltaX = <span class="cstat-no" title="statement not covered" >point.pageX - this.lastPointX</span>
<span class="cstat-no" title="statement not covered" >  this.lastPointX = point.pageX</span>
&nbsp;
  let deltaY = <span class="cstat-no" title="statement not covered" >point.pageY - this.lastPointY</span>
<span class="cstat-no" title="statement not covered" >  this.lastPointY = point.pageY</span>
&nbsp;
  let newX = <span class="cstat-no" title="statement not covered" >this.x + deltaX</span>
  let newY = <span class="cstat-no" title="statement not covered" >this.y + deltaY</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._pos(newX, newY)</span>
}
&nbsp;
Indicator.prototype._end = function (e) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  if (!this.initiated) {</span>
<span class="cstat-no" title="statement not covered" >    return</span>
  }
...
<span class="cstat-no" title="statement not covered" >  e.stopPropagation()</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this._handleMoveEvents(removeEvent)</span>
&nbsp;
  const snapOption = <span class="cstat-no" title="statement not covered" >this.scroller.options.snap</span>
<span class="cstat-no" title="statement not covered" >  if (snapOption) {</span>
    let {speed, easing = ease.bounce} = <span class="cstat-no" title="statement not covered" >snapOption</span>
    let snap = <span class="cstat-no" title="statement not covered" >this.scroller._nearestSnap(this.scroller.x, this.scroller.y)</span>
&nbsp;
    let time = <span class="cstat-no" title="statement not covered" >speed || Math.max(</span>
        Math.max(
          Math.min(Math.abs(this.scroller.x - snap.x), 1000),
          Math.min(Math.abs(this.scroller.y - snap.y), 1000)
        ), 300)
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (this.scroller.x !== snap.x || this.scroller.y !== snap.y) {</span>
<span class="cstat-no" title="statement not covered" >      this.scroller.directionX = 0</span>
<span class="cstat-no" title="statement not covered" >      this.scroller.directionY = 0</span>
<span class="cstat-no" title="statement not covered" >      this.scroller.currentPage = snap</span>
<span class="cstat-no" title="statement not covered" >      this.scroller.scrollTo(snap.x, snap.y, time, easing)</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (this.moved) {</span>
<span class="cstat-no" title="statement not covered" >    this.scroller.trigger('scrollEnd', {</span>
      x: this.scroller.x,
      y: this.scroller.y
    })
  }
...
&nbsp;
Indicator.prototype._pos = function (x, y) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  if (x &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    x = 0</span>
  } else <span class="cstat-no" title="statement not covered" >if (x &gt; this.maxPosX) {</span>
<span class="cstat-no" title="statement not covered" >    x = this.maxPosX</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (y &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    y = 0</span>
  } else <span class="cstat-no" title="statement not covered" >if (y &gt; this.maxPosY) {</span>
<span class="cstat-no" title="statement not covered" >    y = this.maxPosY</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  x = Math.round(x / this.sizeRatioX)</span>
<span class="cstat-no" title="statement not covered" >  y = Math.round(y / this.sizeRatioY)</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  this.scroller.scrollTo(x, y)</span>
<span class="cstat-no" title="statement not covered" >  this.scroller.trigger('scroll', {</span>
    x: this.scroller.x,
    y: this.scroller.y
  })
}
&nbsp;
Indicator.prototype._shouldShow = function () <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  if ((this.direction === 'vertical' &amp;&amp; this.scroller.hasVerticalScroll) || (this.direction === 'horizontal' &amp;&amp; this.scroller.hasHorizontalScroll)) {</span>
<span class="cstat-no" title="statement not covered" >    this.wrapper.style.display = ''</span>
<span class="cstat-no" title="statement not covered" >    return true</span>
  }
<span class="cstat-no" title="statement not covered" >  this.wrapper.style.display = 'none'</span>
...
&nbsp;
Indicator.prototype._addDOMEvents = function () <span class="fstat-no" title="function not covered" >{</span>
  let eventOperation = <span class="cstat-no" title="statement not covered" >addEvent</span>
<span class="cstat-no" title="statement not covered" >  this._handleDOMEvents(eventOperation)</span>
}
&nbsp;
Indicator.prototype._removeDOMEvents = function () <span class="fstat-no" title="function not covered" >{</span>
  let eventOperation = <span class="cstat-no" title="statement not covered" >removeEvent</span>
<span class="cstat-no" title="statement not covered" >  this._handleDOMEvents(eventOperation)</span>
<span class="cstat-no" title="statement not covered" >  this._handleMoveEvents(eventOperation)</span>
}
&nbsp;
Indicator.prototype._handleMoveEvents = function (eventOperation) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  if (!this.scroller.options.disableTouch) {</span>
<span class="cstat-no" title="statement not covered" >    eventOperation(window, 'touchmove', this)</span>
  }
<span class="cstat-no" title="statement not covered" >  if (!this.scroller.options.disableMouse) {</span>
<span class="cstat-no" title="statement not covered" >    eventOperation(window, 'mousemove', this)</span>
  }
}
&nbsp;
Indicator.prototype._handleDOMEvents = function (eventOperation) <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >  if (!this.scroller.options.disableTouch) {</span>
<span class="cstat-no" title="statement not covered" >    eventOperation(this.indicator, 'touchstart', this)</span>
<span class="cstat-no" title="statement not covered" >    eventOperation(window, 'touchend', this)</span>
  }
<span class="cstat-no" title="statement not covered" >  if (!this.scroller.options.disableMouse) {</span>
<span class="cstat-no" title="statement not covered" >    eventOperation(this.indicator, 'mousedown', this)</span>
<span class="cstat-no" title="statement not covered" >    eventOperation(window, 'mouseup', this)</span>
  }
}
&nbsp;</pre></td></tr>
</table></pre>
