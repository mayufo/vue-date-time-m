  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>174/222</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">65.43% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>106/162</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.observeDOM) {
      this._initDOMObserver()
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.options.autoBlur) {
...
<span class="cstat-no" title="statement not covered" >      this._initScrollbar()</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.mouseWheel) {
<span class="cstat-no" title="statement not covered" >      this._initMouseWheel()</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.zoom) {
<span class="cstat-no" title="statement not covered" >      this._initZoom()</span>
    }
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.infinity) {
<span class="cstat-no" title="statement not covered" >      this._initInfinite()</span>
    }
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return</span>
    ...
    let key = this.useTransition ? <span class="branch-0 cbranch-no" title="branch not covered" >'isInTransition' </span>: 'isAnimating'
    Object.defineProperty(this, key, {
      get() {
<span class="cstat-no" title="statement not covered" >        return isInTransition</span>
      },
      set(newVal) {
<span class="cstat-no" title="statement not covered" >        isInTransition = newVal</span>
        // fix issue #359
        let el = <span class="cstat-no" title="statement not covered" >me.scroller.children.length ? me.scroller.children : [me.scroller]</span>
        let pointerEvents = <span class="cstat-no" title="statement not covered" >(isInTransition &amp;&amp; !me.pulling) ? 'none' : 'auto'</span>
<span class="cstat-no" title="statement not covered" >        for (let i = 0; i &lt; el.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >          el[i].style.pointerEvents = pointerEvents</span>
        }
      }
    })
  }
&nbsp;
  BScroll.prototype._handleAutoBlur = function () {
    this.on('scrollStart', () =&gt; {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (activeElement &amp;&amp; (activeElement.tagName === 'INPUT' || activeElement.tagName === 'TEXTAREA')) {
<span class="cstat-no" title="statement not covered" >        activeElement.blur()</span>
      }
    })
  }
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof MutationObserver !== 'undefined') {
      ...
      let observer = new MutationObserver((mutations) =&gt; {
        ...
        for (let i = 0; i &lt; mutations.length; i++) {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (mutation.type !== 'attributes') {
<span class="cstat-no" title="statement not covered" >            immediateRefresh = true</span>
<span class="cstat-no" title="statement not covered" >            break</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (immediateRefresh) {
<span class="cstat-no" title="statement not covered" >          this.refresh()</span>
        } else if (deferredRefresh) {
          // attributes changes too often
          clearTimeout(timer)
          timer = setTimeout(() =&gt; <span class="fstat-no" title="function not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            if (!this._shouldNotRefresh()) {</span>
<span class="cstat-no" title="statement not covered" >              this.refresh()</span>
            }
          }, 60)
        }
...
&nbsp;
  BScroll.prototype.handleEvent = function (e) {
    switch (e.type) {
      ...
      case 'mousedown':
        this._start(e)
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.zoom &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >e.touches </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >e.touches.length &gt; 1)</span> {
<span class="cstat-no" title="statement not covered" >          this._zoomStart(e)</span>
        }
        break
      case 'touchmove':
      case 'mousemove':
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.options.zoom &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >e.touches </span>&amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >e.touches.length &gt; 1)</span> {
<span class="cstat-no" title="statement not covered" >          this._zoom(e)</span>
        } else {
          this._move(e)
        }
        break
      ...
      case 'touchcancel':
      case 'mousecancel':
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.scaled) {
<span class="cstat-no" title="statement not covered" >          this._zoomEnd(e)</span>
        } else {
          this._end(e)
        }
        break
...
<span class="cstat-no" title="statement not covered" >        break</span>
<span class="branch-15 cbranch-no" title="branch not covered" >      case 'wheel':</span>
<span class="branch-16 cbranch-no" title="branch not covered" >      case 'DOMMouseScroll':</span>
<span class="branch-17 cbranch-no" title="branch not covered" >      case 'mousewheel':</span>
<span class="cstat-no" title="statement not covered" >        this._onMouseWheel(e)</span>
<span class="cstat-no" title="statement not covered" >        break</span>
    }
  }
&nbsp;
...
&nbsp;
    ...
    if (wheel) {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.options.infinity) {
        this.maxScrollY = this.wrapperHeight - this.scrollerHeight
      }
      if (this.maxScrollX &lt; 0) {
        this.maxScrollX -= this.relativeX
        this.minScrollX = -this.relativeX
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.scale &gt; 1) {
<span class="cstat-no" title="statement not covered" >        this.maxScrollX = (this.maxScrollX / 2 - this.relativeX)</span>
<span class="cstat-no" title="statement not covered" >        this.minScrollX = this.maxScrollX</span>
      }
      if (this.maxScrollY &lt; 0) {
        this.maxScrollY -= this.relativeY
        this.minScrollY = -this.relativeY
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (this.scale &gt; 1) {
<span class="cstat-no" title="statement not covered" >        this.maxScrollY = (this.maxScrollY / 2 - this.relativeY)</span>
<span class="cstat-no" title="statement not covered" >        this.minScrollY = this.maxScrollY</span>
      }
    }
&nbsp;
