...
<template>
  <div class="d-date-time-time-content">
    <div class="d-date-time-item-wrap">
      <i class="iconf iconf-angle-up" @click="changeHour('last')"></i>
      ...
      <i class="iconf iconf-angle-down" @click="changeHour('next')"></i>
    </div>

    <div class="d-date-time-time-dot">:</div>

    <div class="d-date-time-item-wrap">
      <i class="iconf iconf-angle-up" @click="changeMinute('last')"></i>
      <div class="d-date-time-item">
        <div class="d-date-time-cell">{{minutes1}}</div>
        <div class="d-date-time-cell">{{minutes2}}</div>
      </div>
      <i class="iconf iconf-angle-down" @click="changeMinute('next')"></i>
    </div>
  </div>
</template>
